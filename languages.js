...
const translations = {
    ...
    fr: {
        ...
        identify_failed: '❌ Échec d\'identification, veuillez réessayer',
        identify_uncertain: '⚠️ Résultat incertain, assurez un bon éclairage et faites face à la caméra',
        no_face_detected: '❌ Aucun visage détecté, faites face à la caméra',
        detecting: '🔍 Identification en cours, veuillez patienter...',
        detect_failed_retry: '⚠️ Échec de détection, nouvelle tentative...',
        unknown_user: '❌ Utilisateur non reconnu, vérifiez votre enregistrement',
        no_registered_users: '❌ Aucun utilisateur enregistré, contactez l\'administrateur',
        identify_error: '❌ Erreur d\'identification, veuillez réessayer',
        error_model: '❌ Échec du chargement du modèle, actualisez la page',
        error_camera: '❌ Échec de démarrage de la caméra, vérifiez les permissions',
        identify_uncertain_detail: '⚠️ Résultat incertain, ajustez votre angle et réessayez',
        must_check_in_first: 'Veuillez d\'abord pointer votre arrivée',
        already_checked_out: 'Départ déjà enregistré aujourd\'hui',
        must_break_start_first: 'Veuillez d\'abord commencer la pause',
        break_already_ended: 'Pause déjà terminée aujourd\'hui',
        must_end_break_first: 'Veuillez terminer la pause avant de partir',
        already_recorded: ' déjà enregistré, veuillez ne pas répéter',
    ...
    zh: {
        ...
        identify_uncertain: '⚠️ 识别结果不确定，请确保光线充足并正对摄像头',
        no_face_detected: '❌ 未检测到人脸，请正对摄像头',
        detecting: '🔍 正在识别中，请稍候...',
        detect_failed_retry: '⚠️ 检测失败，正在重试...',
        unknown_user: '❌ 未识别到注册用户，请确认已录入人脸',
        no_registered_users: '❌ 暂无注册用户，请联系管理员',
        identify_error: '❌ 识别出错，请重试',
        error_model: '❌ 模型加载失败，请刷新页面重试',
        error_camera: '❌ 摄像头启动失败，请检查权限',
        identify_uncertain_detail: '⚠️ 识别结果不唯一，请调整角度后重试',
        must_check_in_first: '请先进行上班打卡',
        already_checked_out: '今日已完成下班打卡，无法继续打卡',
        must_break_start_first: '请先开始休息',
        break_already_ended: '今日休息已结束，无法再次开始',
        must_end_break_first: '请先结束休息再下班',
        already_recorded: ' 已打卡，请勿重复',
    ...
    // ==================== 英语 (EN) ====================
    en: {
        identify_success: '✅ Identification successful!',
        identify_failed: '❌ Identification failed, please try again',
        identify_uncertain: '⚠️ Uncertain result, please ensure good lighting and face the camera',
        no_face_detected: '❌ No face detected, please face the camera',
        detecting: '🔍 Identifying, please wait...',
        detect_failed_retry: '⚠️ Detection failed, retrying...',
        unknown_user: '❌ Unknown user, please make sure you are registered',
        no_registered_users: '❌ No registered users, please contact admin',
        identify_error: '❌ Identification error, please try again',
        error_model: '❌ Model loading failed, please refresh the page',
        error_camera: '❌ Camera startup failed, please check permissions',
        identify_uncertain_detail: '⚠️ Uncertain result, please adjust your angle and try again',
        must_check_in_first: 'Please check in first',
        already_checked_out: 'Already checked out today, cannot clock further',
        must_break_start_first: 'Please start break first',
        break_already_ended: 'Break already ended today, cannot start again',
        must_end_break_first: 'Please end break before check out',

        already_recorded: ' already recorded, please do not repeat',
